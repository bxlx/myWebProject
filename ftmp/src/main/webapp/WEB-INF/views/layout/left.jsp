    ...
    <div class="sidebar-nav">
        <div class="nav-canvas">
			...
			<ul class="nav nav-pills nav-stacked main-menu">
				<c:forEach items="${sessionScope.sessionUser.permissionMenus}" var="permissionMenu" > 
					<c:choose> 
					  <c:when test="${permissionMenu.childrens != null}">     
					  	 <li class="accordion">
		                    <a href="#"><i class="${permissionMenu.icon}"></i><span>${permissionMenu.name}</span></a>
		                    <ul class="nav nav-pills nav-stacked">
		                    	<c:forEach items="${permissionMenu.childrens}" var="childrenMenu" > 
		                    		<li class="ajax-link">
		             					<a href="${childrenMenu.url}"><i class="${childrenMenu.icon}"></i><span>${childrenMenu.name}</span></a>
			                       </li>    
		                        </c:forEach>
		                    </ul>
		                </li> 
					  ...
					  <c:otherwise>   
					  	 <li><a class="ajax-link" href="${perssionMenu.url}"><i class="glyphicon glyphicon-home"></i><span>${perssionMenu.name}</span></a></li>  
					  </c:otherwise> 
					</c:choose> 
        		</c:forEach> 
